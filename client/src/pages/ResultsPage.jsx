  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-4">
      ...
      <p className="text-slate-500 dark:text-slate-400 mb-6 max-w-sm text-sm">
        Complete the 6-step wizard to get your personalized cloud provider recommendation.
      </p>
      <Link
        to="/wizard"
...
export default function ResultsPage() {
  ...
  // Decode ?share= param on first load — restores a shared recommendation
  useEffect(() => {
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm">
            Scored across 5 dimensions — ranked best to worst for your project.
          </p>
        </div>
